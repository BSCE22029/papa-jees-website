...
import { menu, siteConfig } from "@/lib/site-config";
import { Flame, Sparkles, Trophy } from "lucide-react";

export const metadata: Metadata = {
  title: "Menu",
  description: `Explore the full menu at ${siteConfig.name} — signature burgers, sides, and beverages.`,
};

const tagIcon = { bestseller: Trophy, new: Sparkles, spicy: Flame } as const;

export default function MenuPage() {
  return (
    <div className="container-page py-16 sm:py-24">
      <MotionSection>
        <p className="text-sm font-semibold uppercase tracking-wide text-brand-600">Our Menu</p>
        <h1 className="mt-2 font-display text-4xl font-bold text-ink-900 sm:text-5xl">Made Fresh, Served Fast</h1>
        <p className="mt-4 max-w-lg text-ink-800/70">
          Sample menu shown for demonstration — final menu and pricing to be confirmed with {siteConfig.name} before
          launch.
        </p>
      </MotionSection>
